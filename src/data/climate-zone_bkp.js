const climateZoneData = [
  ...
  },
  {
    ...
    longDescription:
      'The driest month (which nearly always occurs at or soon after the "winter" solstice for that side of the equator) with precipitation less than 60 mm (2.4 in), but more than 4% the total annual precipitation.',
  },
  {
    subZone: 'As',
    color: '#000000',
  ...
  },
  {
    ...
    longDescription:
      'The driest month having precipitation less than 60 mm (2.4 in) and less than 4% of the total annual precipitation.',
  },
  {
    subZone: 'BSh',
    color: '#000000',
  ...
  },
  {
    ...
    longDescription:
      "Temperate, without dry season, hot summer. With the coldest month averaging above 0 °C (32 °F), at least one month's average temperature above 22 °C (71.6 °F), and at least four months averaging above 10 °C (50 °F). No significant precipitation difference between seasons. No dry months in the summer.",
  },
  {
    subZone: 'Cfb',
    color: '#FFFFFF',
    ...
    longDescription:
      'Temperate, without dry season, warm summer. Coldest month averaging above 0 °C (32 °F), all months with average temperatures below 22 °C (71.6 °F), and at least four months averaging above 10 °C (50 °F). No significant precipitation difference between seasons.',
  },
  {
    subZone: 'Cfc',
    color: '#FFFFFF',
    ...
    longDescription:
      'Temperate, without dry season, cold summer. The coldest month averaging above 0 °C (32 °F) and 1–3 months averaging above 10 °C (50 °F). No significant precipitation difference between seasons.',
  },
  {
    subZone: 'Csa',
    color: '#000000',
  ...
  },
  {
    ...
    longDescription:
      'Temperate, dry cold summer. The coldest month averaging above 0 °C (32 °F) and 1–3 months averaging above 10 °C (50 °F). At least three times as much precipitation in the wettest month of winter as in the driest month of summer, and driest month of summer receives less than 30 mm (1.2 in).',
  },
  {
    subZone: 'Cwa',
    color: '#000000',
  ...
  },
  {
    ...
    longDescription:
      'Polar eternal winter. With all 12 months of the year with average temperatures below 0 °C (32 °F).',
  },
  {
    subZone: 'ET',
    color: '#000000',
    ...
    longDescription:
      'Polar tundra. All 12 months of the year with average temperatures between 0 °C (32 °F) and 10 °C (50 °F).',
  },
  {
    subZone: 'Dfa',
    color: '#FFFFFF',
    ...
    longDescription:
      "Continental without dry season, hot summer. The coldest month averaging below 0 °C (32 °F), at least one month's average temperature above 22 °C (71.6 °F), and at least four months averaging above 10 °C (50 °F). No significant precipitation difference between seasons.",
  },
  {
    subZone: 'Dfb',
    color: '#FFFFFF',
    ...
    longDescription:
      'Continental without dry season, warm summer. The coldest month averaging below 0 °C (32 °F), all months with average temperatures below 22 °C (71.6 °F), and at least four months averaging above 10 °C (50 °F). No significant precipitation difference between seasons.',
  },
  {
    subZone: 'Dfc',
    color: '#FFFFFF',
    ...
    longDescription:
      'Continental without dry season, cold summer. The coldest month averaging below 0 °C (32 °F) and 1–3 months averaging above 10 °C (50 °F). No significant precipitation difference between seasons.',
  },
  {
    subZone: 'Dfd',
    color: '#000000',
    ...
    longDescription:
      'Continental without dry season, very cold winter. The coldest month averaging below ?38 °C (?36.4 °F) and 1–3 months averaging above 10 °C (50 °F). No significant precipitation difference between seasons.',
  },
  {
    subZone: 'Dsa',
    color: '#FFFFFF',
  ...
  },
  {
    ...
    longDescription:
      'Continental, dry cold summer. The coldest month averaging below 0 °C (32 °F) and 1–3 months averaging above 10 °C (50 °F). At least three times as much precipitation in the wettest month of winter as in the driest month of summer, and driest month of summer receives less than 30 mm (1.2 in).',
  },
  {
    subZone: 'Dwa',
    color: '#FFFFFF',
